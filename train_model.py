...
trainloader = DataLoader(traindataset, batch_size= PRMS['batch_size'], shuffle=False)
...
beautiful_eyes_model.fc = nn.Linear(512,2, bias=True)

#beautiful_eyes_model.load_state_dict(torch.load("C:/Users/hugob/Desktop/Projet INF573/eye_detection/ourmodel.pth"))
...
if __name__ == "__main__":
    ...
    trainer(model = beautiful_eyes_model, loss_fn = lossfn, epoch = 10, rate = 5e-4)

    print(avg_distance_error(model = beautiful_eyes_model))

    print("training finished")
    torch.save(beautiful_eyes_model.state_dict(), "C:/Users/hugob/Desktop/Projet INF573/eye_detection/ourmodel.pth")
    print("model saved")
