...
class Coordinates:
    ...
    def normalize(self, shift_x, shift_y, shift_z, factor_x, factor_y, factor_z):
    ...
    @classmethod
    def normalize_list(cls, coords: List["Coordinates"], method: str = "minmax"):
        if method == "minmax":
        ...
        for coord in coords:
            coord.normalize(shift_x, shift_y, shift_z, range_x, range_y, range_z)
        return coords

    @classmethod
    def normalize_dict(cls, coords: dict, method: str = "minmax"):
        if method == "minmax":
